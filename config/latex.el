...
(add-hook 'tex-mode-hook
	    ...
	    (set-face-attribute 'font-latex-sedate-face nil :foreground "blue")
	    ...
	    (set-face-attribute 'font-latex-sectioning-2-face nil :foreground "brightgreen")
	    (set-face-attribute 'font-latex-sectioning-3-face nil :foreground "color-49")
	    (set-face-attribute 'font-latex-sectioning-5-face nil :foreground "color-50")
